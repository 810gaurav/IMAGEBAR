...
<body>
  ...
  <div>
    <img src="img/animal3.jpg" class="w-100" height="550px" alt="image is loading">
  </div>
  <h1 class="card-title">YEAR TRENDS</h1>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/3d3.jpg" Download="" style="text-decoration: none;">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/animation3.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animation3.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/animal7.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal7.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k4.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/4k4.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/hd5.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/hd5.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/animal5.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/3d6.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/f2.jpg" class="bd-placeholder-img card-img-top" width="100%" height="325">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/f2.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
  ...
  <div id="slider-body">
    <div class="con-2">
      <div class="slide-container">
        ...
        <div class="slide-image">
          <a href="animl.php"><img src="img/animal8.jpg" alt="loading"></a>
        </div>
        <div class="slide-image">

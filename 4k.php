...
<body>
  ...
  <div>
    <img src="img/4k4.jpg" class="w-100" height="550px" alt="image is loading">
  </div>
  <h1 class="card-title">4K World</h1>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/3d3.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k2.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/4k2.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k3.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/4k3.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k6.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/4k6.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k7.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/4k7.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>

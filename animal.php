...
<body>
  ...
  <div>
    <img src="img/animal8.jpg" class="w-100" height="550px" alt="image is loading">
  </div>
  <h1 class="card-title">Animal Planet</h1>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/animal6.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal6.jpg" Download="" style="text-decoration: none;">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/animal9.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal9.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/Animal2.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal2.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/Animal3.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal3.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/Animal4.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal4.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/animal5.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/Animal8.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">

...
<body>
  ...
  <div>
    <img src="img/dark6.jpg" class="w-100" height="550px" alt="Image is loading">
  </div>
  <h1 class="card-title">Dark World</h1>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/dark4.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark4.jpg" Download="" style="text-decoration: none;">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/dark9.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark9.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/dark2.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark2.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark3.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/dark8.jpeg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark5.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/dark7.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-lg btn-outline-secondary"><a
                    href="./img/dark7.jpg" Download="" style="text-decoration: none;">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></button></a>

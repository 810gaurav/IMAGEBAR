...
<body>
  ...
  <div>
    <img src="img/3d7.jpg" class="w-100" height="550px" alt="Image is loading">
  </div>
  <h1 class="card-title">3D World</h1>
    ...
    <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 g-3">
      <div class="col">
        <div class="card shadow-sm">
          <img src="./img/3d1.jpg" class="bd-placeholder-img card-img-top" height="325">
            ...
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">
                ...
                <button type="button" class="btn btn-lg btn-outline-secondary "><a
                    href="./img/3d1.jpg" Download=""><i class="fa-solid fa-arrow-down-long"
                      style="color: #171716;"></i>
                  </a></button>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/3d2.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="225">
          <div class="card-body">
            <div class="d-flex justify-content-space-around align-items-center">
              <div class="btn-group">

                <button type="button" class="btn btn-lg btn-outline-secondary btn-outline-secondary"><a
                    href="./img/3d2.jpg" Download="">
                    <i class="fa-solid fa-arrow-down-long" style="color: #171716;"></i></a></button>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/3d5.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/4k.jpg" class="bd-placeholder-img card-img-top" width="100%" height="225">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <img src="./img/3d7.jpg" class="bd-placeholder-img card-img-top" width="100%"
            height="325">
